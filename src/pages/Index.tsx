            ...
            <div className="relative max-w-3xl mx-auto mb-12">
              <div className="relative group">
                <Input
                  ...
                  className="w-full h-14 bg-black/50 backdrop-blur-xl text-gray-200 border-2 border-neutral-700/50 rounded-2xl pl-14 pr-14 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500/50 transition-all text-lg shadow-xl shadow-emerald-900/5 placeholder:text-gray-400"
                />
